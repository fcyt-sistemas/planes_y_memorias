  ...
  public function index(Request $request)
  {
        ...
        if($request->user()->hasRole('admin')){
            ...
            $planificaciones = Planificacion::whereSede($request->get('sede'))
                                              ...
                                              ->paginate(10);
            return view('admin.planificaciones.index',compact('planificaciones','sedes','carreras'));
        }
        ...
        elseif(Auth::user()->hasRole('control') && \Session::get('tipoUsuario')=='control') {
          ...
          $planificaciones = Planificacion::whereSede($request->get('sede'))
                                            ...
                                            ->revisada($request->get('revisadas'))
                                            ->paginate(10);
          return view('lectura.planificaciones.index',compact('planificaciones','sedes','carreras'));
        }
