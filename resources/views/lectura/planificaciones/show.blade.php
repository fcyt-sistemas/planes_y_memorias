                ...
                <div class="card-header">Planificación cargada por el docente {{ $planificacion->docente->apellidos}}, {{ $planificacion->docente->nombres}}! </div>
                  <div class="card-body">
					...
					<div class="btn-group" role="group">
						...
						<div class="btn-group">
  				        	{!!link_to_route('programa.pdf', $title = 'Descargar Programa PDF', $parameters = $planificacion->id, $attributes = ['class'=>'btn btn-secondary'])!!}
						</div>
						<div class="btn-group">
  				        	{!!link_to_route('planificacion.impresion', $title = 'Impresión completa', $parameters = $planificacion->id, $attributes = ['class'=>'btn btn-secondary'])!!}
						</div>
		            </div>
					{!! Form::close() !!}
				</div>
