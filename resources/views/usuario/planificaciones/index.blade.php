            ...
            <div class="card">
                <div class="card-header form-inline">
                    ...
                    <div class="button push-right">
		        	    {!!link_to_route('planificacion.create', $title = 'Agregar planificación..', $parameters = null, $attributes = ['class'=>'btn btn-secondary'])!!}
	                </div>
                </div>
                                ...
                                <div class="btn-group" role="group">
                                   <div class="btn-group">
                                      ...
                                      @if(!$p->observado and!$p->aprobado and !($p->fecha_entrega<>null)){!!link_to_action('PlanificacionController@entregar', $title = 'Entregar!', $parameters = $p->id, $attributes = ['class'=>'btn btn-secondary'])!!} @endif
			  	                      @if((!($p->observado))and((!($p->aprobado)))){!!Form::open(['route'=>['planificacion.destroy',$p['id']],'method'=>'DELETE','class' =>'form-inline form-delete'])!!}
